  ...
  augeas {
    'Leap_MX_Procs':
      ...
      changes => [
        ...
        'set Leap_MX_Procs \'/usr/lib/nagios/plugins/check_procs -w 1:1 -c 1:1 -a "/usr/bin/python /usr/bin/twistd --pidfile=/var/run/leap_mx.pid --rundir=/var/lib/leap_mx/ --python=/usr/share/app/mx.tac --logfile=/var/log/leap/mx.log"\'' ],
